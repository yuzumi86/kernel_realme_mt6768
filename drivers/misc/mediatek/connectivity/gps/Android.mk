...
ifneq (,$(filter mt6877 mt6879 mt6885 mt6893 mt6983 mt6768,$(TARGET_BOARD_PLATFORM)))
#Only set dependency to conninfra.ko when CONSYS_CHIP in list.
ifneq (,$(filter CONSYS_6877 CONSYS_6879 CONSYS_6885 CONSYS_6893 CONSYS_6983 CONSYS_6768,$(MTK_COMBO_CHIP)))
